...
export default function AnimalCard(animal: AnimalCardProps) {
    return (
        <div className="w-56 h-72 bg-white hover:bg-orange-400 hover:scale-105 cursor-pointer rounded-2xl drop-shadow-md m-4 group">
             <img className="rounded-t-2xl rounded-bl-2xl max-w-full aspect-square" src='https://content.imageresizer.com/images/memes/War-Cat-meme-88f6yf.jpg' alt="animal" />
            <div className="p-2">
