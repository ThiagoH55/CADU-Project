...
export default function FiltroAnimais() {
  ...
  return (
    <div className="font-[family-name:var(--font-be-vietnam-regular)] flex flex-col items-center mx-16 w-64 min-h-96 bg-white rounded-2xl drop-shadow-md m-4 text-gray-700">
