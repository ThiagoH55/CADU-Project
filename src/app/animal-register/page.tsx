                ...
                <div className="bg-white w-7/10 h-4/6 mt-10 drop-shadow-4xl rounded-3xl">
                    <div className="w-full flex p-5">
                        ...
                        <form className="w-4/6 font-[family-name:var(--font-be-vietnam)]">
                            <h1 className="text-orange-500 text-center ml-16 text-5xl ">CADASTRO DE ANIMAL</h1>
                            <div className="flex flex-row gap-24">
                                ...
                                <div className="mt-14 ml-5 text-black">
                                    ...
                                    <label className="text-2xl" htmlFor="descricao">Descrição</label>
                                    <textarea className="bg-gray-300 px-2 min-w-60 min-h-20 resize-none rounded-md" name="descricao" />
                                    <button className="flex mt-10 px-5 py-3 justify-self-center rounded-full text-sm text-white bg-orange-500 " type="submit" >CADASTRAR</button>
